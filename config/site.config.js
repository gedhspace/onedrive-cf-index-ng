...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'gdh20111218@outlook.com',
  ...
  protectedRoutes: ['/图片','/文档','/桌面'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:738813115@qq.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/gedhspace',
    },
  ],
